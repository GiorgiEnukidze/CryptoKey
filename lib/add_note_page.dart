...
import 'package:flutter_kryptokey_1/secure_note_page.dart'; // Assurez-vous que le nom de la page de liste de notes est correctement importé
  ...
  Future<void> _saveNote() async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://127.0.0.1:8000/api/notes/add/'), // Assurez-vous que l'URL de l'API est correcte
        headers: {
