...
class _IdCardPageState extends State<IdCardPage> {
  ...
  Future<void> loadIdCards() async {
    ...
    final response = await http.get(
      Uri.parse('http://127.0.0.1:8000/api/identities/'),
      headers: {
  ...
  Future<void> _updateIdCard(
    ...
    final response = await http.patch(
      Uri.parse('http://127.0.0.1:8000/api/identities/update/$cardId/'),
      headers: {
        'Authorization': 'Bearer $token',
  ...
  Future<void> _deleteIdCard(int cardId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('http://127.0.0.1:8000/api/identities/delete/$cardId/'),
        headers: {
          'Authorization': 'Bearer $token',
        },
      );
